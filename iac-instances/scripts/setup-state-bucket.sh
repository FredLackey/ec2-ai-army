...
# Setup script for S3 state bucket and DynamoDB table for Instances module
...
PROFILE=""
REGION=""
BUCKET_NAME="tfstate-ai-army-instances"
...
Creates AWS resources for Terraform remote state backend for the Instances module.
...
This will create:
  - S3 bucket: tfstate-ai-army-instances
  - DynamoDB table: tfstate-ai-army-instances-locks
